  ...
  <div class="dashboard">
    ...
    <el-card style="margin-top: 16px" shadow="hover">
      ...
      <el-steps :active="7" finish-status="success" align-center>
        ...
        <el-step title="配送验收" description="送货单/验收单/打印/短损" />
        <el-step title="采购管理" description="供应商/采购单/从订单生成" />
        <el-step title="报表中心" description="日报/月结/利润/明细/损耗/采购/对账" />
      </el-steps>
    </el-card>
  </div>
</template>
